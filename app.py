...
st.set_page_config(page_title = 'Survey Results') #setting the page title
st.header('Survey Results 2021') # giving a name to the header
st.subheader('Was it helpful?') # giving a subheader
...
# Display image and data frame together
...
col1.image(image, caption = 'Photo', use_column_width = True)
...
# making  apie chart of the participants table
